...
import ReservationCreatePaymentWrapper from "./pages/reservation/ReservationCreatePayment";
import SeatSelect from "./pages/reservation/ReservationSeatSelect";
      ...
      <div>
        ...
        <Route path={routes.app} element={<Login />} />
          ...
          <Route element={<Layout />}>
            ...
            />
            <Route path={routes.reservationConfirm} element={<SeatSelect />} />
            <Route
              path={routes.reservationPayment}
              element={<ReservationCreatePaymentWrapper />}
            />
